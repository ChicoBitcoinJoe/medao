...
function ($q,Web3Service) {
    ...
    var platform = {
        registry:{
            address:'0xde5AFa7d15d3456434dA221182287E193f395118',
        ...
        factory:{
            ...
            v1: {
                address:'0x01b5badC7ACA5adAbE3561bEea86031C2E5627C6',
            },
            v2: {
                address:'',
            }
    ...
    var service = {
        ...
        update: function(name){
            ...
            $q.all([
                ...
                Factory.update(name, {from:account,gasPrice:gasPrice},
                function(err, tx){
                    if(!err)
                        deferred.resolve(tx);
                    else 
